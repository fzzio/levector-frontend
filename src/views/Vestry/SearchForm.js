...
class SearchForm extends Component {
    ...
    componentDidMount() {
        // fetch all API data
        const requestCustomFields = axios.get(defines.API_DOMAIN + '/field?module=' + defines.LVT_VESTRY);
    ...
    handleSubmit(event) {
        ...
        const vestrySearchData = {
            idvestry: this.state.formFields.lvtId,
        ...
        console.log("-- vestrySearchData --");
        console.log(JSON.stringify(vestrySearchData));
        ...
        axios.post(
            ...
            .then((response) => {
                if (response.status === 200) {
                    ...
                    this.props.updateActiveSearch(vestrySearchData);
                } else {
